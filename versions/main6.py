...
start_img = pygame.image.load("Base pack/startbutton.jpg")
exit_img = pygame.image.load("Base pack/exitbutton.jpg")
restart_img = pygame.image.load("Base pack/restartbutton.jpg")
