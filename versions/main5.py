...
restart_img = pygame.image.load("Base pack/p1_duck.png")
...
class Player():
    ...
    def update(self, game_over):
        ...
        if game_over == 0:
            ...
            draw_text("ZAHYNUL SI!", font, red, (screen_width // 2) - 200, (screen_height //2) - 100)
            self.rect.y -= 5
    ...
    if main_menu == True:
        ...
        if game_over == 1:
            ...
            if level <= max_levels:
                ...
                draw_text("YOU WIN!", font, red, (screen_width // 2) - 200, screen_height // 2)
                if restart_buttom.draw():
                    level = 1
                    world_data = []
                    world = reset_level(level)
